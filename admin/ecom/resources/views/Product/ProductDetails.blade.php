                ...
                if(response.status==200){
                    ...
                    $.each(response.data,function (i,item){
                        let tableRow="<tr>" +
                            ...
                            "<a class='dropdown-item deleteItem' data-id="+item['id']+" data-img="+item['img1']+" data-img2="+item['img2']+" data-img3="+item['img3']+" data-img4="+item['img4']+" href='#'>Delete</a>"+
                    ...
                    $('.deleteItem').on('click',function () {
                        let id=$(this).data('id');
                        let imgOne=$(this).data('img');
                        let imgTwo=$(this).data('img2');
                        let imgThree=$(this).data('img3');
                        let imgFour=$(this).data('img4');
            ...
            axios.get(URL,AxiosConfig).then(function (response){
                if(response.status===200){
                    ...
                    $.each(JSONData, function (key, value) {
                        let OneData="<option value='"+value['product_code']+"'>"+value['product_code']+'('+value['product_name']+')'+"</option>";                   
                             $("#product_code").append(OneData);
                    });
            ...
            if(product_code.length===0){
                ...
                axios.post(URL,UploadFormData,AxiosHeaderConfig).then(function (response){
                    ...
                    if(response.data==1){
                        ...
                        ErrorToast("Product Details Already Added");
