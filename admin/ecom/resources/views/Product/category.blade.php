                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-12 d-none">
                                ...
                                <input  id="old_cat_name" class="form-control" type="text">
                            </div>
                            <div class="col-md-12 col-sm-12 col-12">
...
@section('script')
    <script>
            ...
            axios.get(URL).then(function (response) {
                if(response.status==200){
                    ...
                    $.each(response.data,function (i,item){
                        let tableRow="<tr>" +
                            "<td>"+i+"</td>" +
                            "<td><img style='height: 50px;width: 50px;' src='"+item['category_image']+"'></td>" +
                            ...
                            "<a class='dropdown-item deleteItem' data-id="+item['id']+" data-img="+item['category_image']+" href='#'>Delete</a>"+
                            "<a class='dropdown-item editCategory' data-id="+item['id']+" href='#'>Edit Category</a>"+
                            "<a class='dropdown-item changeImage' data-id="+item['id']+" data-img="+item['category_image']+" href='#'>Change Image</a>"+
                            "</div>" +
                            "</div>" +
                            "</td>" +
                            "</tr>";
        ...
        function GetCategoryNameEditData(idDetails){
            ...
            axios.post(URL,{id:idDetails},AxiosConfig).then(function (response) {
                ...
                if (response.status===200) {
                    ...
                    $('#old_cat_name').val(EditData[0]['category_name']);
                    $('#new_cat_name').val(EditData[0]['category_name']);
                }
                else {
        ...
        $('#EditCategoryBtn').on('click',function (){
            ...
            let old_cat_name= $('#old_cat_name').val();
            ...
            if(new_cat_name.length===0){
                ...
                UploadFormData.append('old_cat_name',old_cat_name);
