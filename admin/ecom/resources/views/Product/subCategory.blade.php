...
@section('content')
    ...
    <div class="modal fade" id="CatEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <p class="modal-title" id="exampleModalLabel">Edit SubCategory</p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-12 d-none">
                                ...
                                <input id="old_sub_name" class="form-control" type="text">
                                <input  id="sub_id" class="form-control" type="text">
                            </div>
                            <div class="col-md-12 col-sm-12 col-12">
                                <label>SubCategory Name</label>
                                <input id="new_sub_name" class="form-control" type="text">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script')
    <script>
        ...
        function GetCategoryNameEditData(idDetails){
            ...
            axios.post(URL,{id:idDetails},AxiosConfig).then(function (response) {
                ...
                if (response.status===200) {
                    ...
                    $('#old_sub_name').val(EditData[0]['subcategory_name']);
                    $('#new_sub_name').val(EditData[0]['subcategory_name']);
                    $('#sub_id').val(EditData[0]['id']);
                }
                else {
        ...
        $('#EditCategoryBtn').on('click',function (){
            ...
            let old_sub_name= $('#old_sub_name').val();
            let new_sub_name= $('#new_sub_name').val();

      
            if(new_sub_name.length===0){
                ...
                let UploadFormData=new FormData();
                UploadFormData.append('sub_id',subid);
                UploadFormData.append('old_sub_name',old_sub_name);
                UploadFormData.append('new_sub_name',new_sub_name);
