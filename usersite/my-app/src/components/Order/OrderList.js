...
class OrderList extends Component {
    ...
    componentDidMount() {
        window.scroll(0,0)
        axios.get(ApiUrl.orderList(LocalStorageHelper.getUserMobile())).then(response=> {
    ...
    PostReview=()=>{
       ...
       if(name.length===0){
           ...
           toast.error('Select rating point',{
           ...
           toast.error("Comments can't more than 150 character",{
           ...
           myFromData.append('rating',rating)
           myFromData.append('comments',comments)
