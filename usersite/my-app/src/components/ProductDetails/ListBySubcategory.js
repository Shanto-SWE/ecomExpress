...
class ListBySubcategory extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(ApiUrl.productListBySubcategory(this.props.category,this.props.subcategory)).then(response=>{
    ...
    render() {
      ...
      <h4 className="section-title pt-5 pb-3">{this.props.subcategory}</h4>
