    ...
    render() {
        const settings = {
          ...
          const MyView=sliderList.map((slider,i)=>{
              return <div  key={i.toString()} className="container-fluid bg-light p-0 m-0 overflow-hidden w-100  sliderhome">
              <div style={{  backgroundColor:slider.bg_color}} className=" w-100">
